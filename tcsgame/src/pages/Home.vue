    ...
    methods: {
      ...
      newFood(time) {
        ...
        this.foodInt = setInterval(() => {
          let newFoods = {}
          newFoods.left = Math.floor((Math.random() * (this.screenWidth - 10) + 10) % 20) * 20 + 'px'
          newFoods.top = Math.floor((Math.random() * (this.screenHeight - 10) + 10) % 20) * 20 + 'px'
